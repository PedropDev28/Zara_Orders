...
import environ
"""
Django settings for zara_orders project.
...
SECRET_KEY = 'django-insecure-)j8&pfx==-u27k(s#0*ar-rzn75zyfut26f(r*4g&=v+^ts!jy'
...
WSGI_APPLICATION = 'zara_orders.wsgi.application'
